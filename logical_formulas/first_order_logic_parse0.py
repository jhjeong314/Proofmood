# This module is to be used in Google Colab.

# The only difference between this file and first_order_logic_parser.py is that
#   we commented out the following line in this file.
#   # plt.rcParams["text.usetex"] = True 
# This is because Google Colab does not handle this line well.
# So some LaTeX symbol cannot be rendered in Google Colab.
# Among those unfortunate symbols are \le, \ge etc.
